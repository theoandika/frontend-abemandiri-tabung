...
export default function DashboardBookingPopular() {
  ...
  return (
    <Box>
      ...
      <Card className="outline-background-paper relative flex h-76.5 p-0 outline-4 -outline-offset-4">
        <Box className="bg-primary-light/10 absolute inset-1 z-0 rounded-xl"></Box>
        <Box className="from-background-paper to-background-paper/0 absolute inset-1 z-0 rounded-xl bg-linear-to-r rtl:bg-linear-to-l"></Box>
