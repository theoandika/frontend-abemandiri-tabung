...
export default function DetailSupplierTransaction({ data, onBack }: DialogProps) {
        ...
        <Card>
          <CardContent>
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 6, md: 8}}>
                {data?.transaction_type == 'refill' && 'Isi Ulang'}
                {data?.transaction_type == 'filled' && 'Selesai Isi Ulang'}
                {data?.transaction_type == 'fixing' && 'Perbaikan'}
                {data?.transaction_type == 'fixed' && 'Selesai Perbaikan'}
              </Grid>
              <Grid size={{ xs: 6, md: 4}}>
                Kondisi :
              </Grid>
